...
$(window).load(function() {
  ...
  setTimeout(function() {
    $('<div class="message new"><figure class="avatar"><img src="/static/robo1.jpg" /></figure>' + 'I am your chatbot, I will be your Nurse for the meantime. Tell me about what you feel, and I will provide possible diagnosis. I will also provide analgesics, treatment scans, and diet for your possible illness.' + '</div>').appendTo($('.mCSB_container')).addClass('new');
        setDate();
        updateScrollbar();
    textToSpeech('Greetings!' );        
   textToSpeech('I am Armando, how are you?, what do you feel right now?' );
  }, 100);
});
